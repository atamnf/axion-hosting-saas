...
⚠️ Исходный код проекта не опубликован по соображениям безопасности и коммерческой тайны.

Репозиторий содержит только описание архитектуры и функциональности системы.  
Доступ к коду возможен по запросу на собеседовании.
